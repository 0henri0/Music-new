...
@extends('pages.layouts.index') @section('content')
    ...
    <div class="browse">
        <div class="tittle-head two">
            <h3 class="tittle">ALL Singer<span class="new">Singer</span></h3>
                    ...
                    <div class="browse-inner">
                        ...
                        @foreach($singerAll as $singer)
                            <div class="col-md-3 artist-grid">
                                <a href="{{url('#')}}"><img class="avatar-category-list" src="{!! $singer->avatar !!}" title="{!! $singer->name !!}"></a>
                                <a href="{{url('#')}}"><i class="glyphicon glyphicon-play-circle"></i></a>
                                <a class="art" href="{{url('#')}}" > {!!cutString($singer->name,15)!!}</a>
                            </div>
                        @endforeach
