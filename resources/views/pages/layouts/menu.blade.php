			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="{{url('/categories')}}"><i class="camera"></i> <span>Category</span></a></li>
					...
					<div class="modal-content">
						...
						<div class="col-md-5 app-left mpl">
							...
							<div class="app-devices">
								...
								<a href="#"><img src="{!! asset('pages/images/1.png') !!}" alt=""></a>
								<a href="#"><img src="{!! asset('pages/images/2.png') !!}" alt=""></a>
								<div class="clearfix"> </div>
							</div>
						</div>
						<div class="col-md-7 app-image">
							<img src="{!! asset('pages/images/apps.png') !!}" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
							</div>
								...
								<div class="sign">
									...
									<div class="sign-right">
										<form action="{{ route('register') }}" method="post">
											...
											<input name="email" type="text" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
											<input name="password" type="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
											<input name="password_confirmation" type="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
