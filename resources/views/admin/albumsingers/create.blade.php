...
@section('content')
        ...
        <div class="col-sm-12">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>{{trans('albumsingers.create')}} </h1>
                </div>
            </div>
        </div>
    </div>
    <div class="col-12" style="padding-bottom:120px">
        ...
        @endif
        {!! Form::open(['url' => "admin/albumsingers/",'files' => true, 'method' => 'post']) !!}
        {!! Form::token()!!}
        ...
        <div class="form-group">
            {!!Form::label(trans('albumsingers.singer')) !!}
            <br>
            <select id="select-state" name="singer_id" class="demo-default" style="width:600px"
        ...
        <div class="form-group" style="width: 600px">
            ...
            <div class="input-group">
                <div class="custom-file">
                    {!!Form::file('avatar',$attributes = ['class'=>'custom-file-input','id'=>'avatar', 'required'=>'' ]) !!}
